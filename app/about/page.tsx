...
export default function AboutPage(){
 return <main className="about-page">
  <nav className="nav shell about-nav"><Link href="/" className="logo asset-logo"><img src="/omnirelay-logo.jpeg" alt="OmniRelay"/></Link><div className="links"><Link href="/#platform">Platform</Link><Link href="/#impact">Impact</Link><Link href="/login">Sign in</Link></div><Link className="btn dark navbtn" href="/login">Start free trial ↗</Link></nav>
