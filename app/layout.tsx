...
export const metadata: Metadata = {
  title: {
    default: "OmniRelay — Connect. Automate. Grow.",
    template: "%s | OmniRelay",
  },
  description:
    "Omnichannel conversations, AI agents, bookings and automation for modern service businesses.",
  other: {
  ...
  icons: {
    icon: [
      ...
      { url: "/omnirelay-favicon-square-v5.png", type: "image/png", sizes: "512x512" },
    ],
    shortcut: "/omnirelay-favicon-square-v5.png",
    apple: [
      { url: "/omnirelay-app-icon-v4.png", sizes: "512x512", type: "image/png" },
    ],
  },
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${geistSans.variable} ${geistMono.variable}`}>
      <head>
        <link rel="apple-touch-startup-image" href="/pwa-assets/apple-splash-2064-2752.jpg" media="(device-width: 1032px) and (device-height: 1376px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)" />
        <link rel="apple-touch-startup-image" href="/pwa-assets/apple-splash-2752-2064.jpg" media="(device-width: 1032px) and (device-height: 1376px) and (-webkit-device-pixel-ratio: 2) and (orientation: landscape)" />
        ...
        <link rel="apple-touch-startup-image" href="/pwa-assets/apple-splash-1668-2420.jpg" media="(device-width: 834px) and (device-height: 1210px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)" />
        <link rel="apple-touch-startup-image" href="/pwa-assets/apple-splash-2420-1668.jpg" media="(device-width: 834px) and (device-height: 1210px) and (-webkit-device-pixel-ratio: 2) and (orientation: landscape)" />
        ...
        <link rel="apple-touch-startup-image" href="/pwa-assets/apple-splash-1260-2736.jpg" media="(device-width: 420px) and (device-height: 912px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)" />
        <link rel="apple-touch-startup-image" href="/pwa-assets/apple-splash-2736-1260.jpg" media="(device-width: 420px) and (device-height: 912px) and (-webkit-device-pixel-ratio: 3) and (orientation: landscape)" />
        ...
        <link rel="apple-touch-startup-image" href="/pwa-assets/apple-splash-1080-2340.jpg" media="(device-width: 360px) and (device-height: 780px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)" />
        <link rel="apple-touch-startup-image" href="/pwa-assets/apple-splash-2340-1080.jpg" media="(device-width: 360px) and (device-height: 780px) and (-webkit-device-pixel-ratio: 3) and (orientation: landscape)" />
