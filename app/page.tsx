...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white text-slate-900 font-sans selection:bg-[#087fb9]/20 selection:text-[#087fb9]">
      ...
      <nav className="fixed top-0 inset-x-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200/80">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 z-50">
            <Link href="/login" className="hidden lg:inline-flex items-center justify-center px-5 h-10 rounded-xl bg-slate-900 text-white text-sm font-semibold hover:bg-slate-800 transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5">
              Start free trial
            </Link>
      ...
      {/* Solutions / Flow */}
      <section id="solutions" className="py-24 lg:py-32 bg-slate-50 border-y border-slate-100">
      ...
      <section id="results" className="py-24 lg:py-32">
        <div className="max-w-7xl mx-auto px-6">
          <div className="rounded-3xl bg-slate-900 text-white p-10 lg:p-20 overflow-hidden relative">
            ...
            <div className="relative z-10">
              <span className="text-xs font-bold text-[#18bfc5] tracking-widest uppercase mb-4 block">The OmniRelay Effect</span>
              <h2 className="text-4xl lg:text-6xl font-semibold tracking-tight leading-tight mb-16">
                Less busywork.<br />
                <span className="text-[#087fb9]">More momentum.</span>
              </h2>
              
              <div className="grid md:grid-cols-3 gap-10 pt-10 border-t border-slate-700/50">
                <div>
                  <span className="block text-5xl lg:text-6xl font-semibold tracking-tight mb-3">98.5%</span>
                  <span className="text-slate-400 text-sm">Conversations resolved automatically</span>
                </div>
                <div>
                  <span className="block text-5xl lg:text-6xl font-semibold tracking-tight mb-3">64%</span>
                  <span className="text-slate-400 text-sm">Less repetitive work</span>
                </div>
                <div>
                  <span className="block text-5xl lg:text-6xl font-semibold tracking-tight mb-3">3.2×</span>
                  <span className="text-slate-400 text-sm">Faster signal to action</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* CTA */}
      <section id="demo" className="pb-24 lg:pb-32 px-6">
        <div className="max-w-7xl mx-auto rounded-3xl bg-gradient-to-br from-slate-50 to-slate-100 border border-slate-200 p-10 lg:p-16 grid lg:grid-cols-[auto_1fr_auto] gap-10 items-center">
