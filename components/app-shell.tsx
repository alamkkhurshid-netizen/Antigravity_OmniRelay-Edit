      ...
      <main className="app-main min-w-0 flex-1 px-4 pb-24 sm:px-6 lg:px-10 lg:pb-12">
        <header className="flex min-h-20 items-center justify-between gap-3 sm:min-h-24">
          ...
          <div className="flex items-center gap-3">
            {browserAlertState === "default" && <button className="hidden min-h-11 items-center gap-2 rounded-xl border border-slate-200/60 bg-white/60 px-4 py-2 text-sm font-bold text-slate-700 shadow-sm backdrop-blur-md transition-all hover:bg-white hover:shadow-md hover:ring-1 hover:ring-slate-200 md:flex" onClick={enableBrowserAlerts}><BellRing className="size-4 text-teal-600" />Enable alerts</button>}
            ...
            <button className="hidden min-h-11 items-center gap-2 rounded-xl border border-slate-200/60 bg-white/60 px-4 py-2 text-sm font-bold text-slate-700 shadow-sm backdrop-blur-md transition-all hover:bg-white hover:shadow-md hover:ring-1 hover:ring-slate-200 sm:flex" type="button" onClick={() => window.dispatchEvent(new Event("omnirelay:start-tour"))}><Sparkles className="size-4 text-indigo-500" />Take a tour</button>
